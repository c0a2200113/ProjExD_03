...
class Bird:
    ...
    def __init__(self, num: int, xy: tuple[int, int]):
        ...
        #     False
        # )
        self.img = self.imgs[(+5, 0)]  # 右向きをデフォルト画像として設定
    ...
    def update(self, key_lst: list[bool], screen: pg.Surface):
        ...
        if not (sum_mv[0] == 0 and sum_mv[1] == 0):  # どれかキーが押されていたら
...
class Score:  # 追加機能3:スコア表示
    ...
    def __init__(self):
        ...
        self.img = self.font.render("スコア:" + str(self.now_score), 0, (0, 0, 255))
        self.rct = self.img.get_rect()
    ...
    while True:
        ...
        for i, bomb in enumerate(bombs):
            if beam is not None and beam.rct.colliderect(bomb.rct):
                ...
                Score.now_score += 1  # 追加機能3:スコア表示 スコア+1
        # Noneでない爆弾だけのリストを作る
